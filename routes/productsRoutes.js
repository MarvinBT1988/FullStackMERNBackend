...
router.get('/', auth, checkRole('ADMIN_ROLE','INVENTORY_ROLE','SALES_ROLE'), productController.getProducts);
router.get('/:id', auth,checkRole('ADMIN_ROLE','INVENTORY_ROLE','SALES_ROLE'), productController.getProductById);
